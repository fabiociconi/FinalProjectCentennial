...
import { CarEntity, AddressEntity } from '@app/entity';
...
export class GoogleMaps {
	@Input()
	private addressIn: AddressEntity;

	@Output() addressOut: EventEmitter<AddressEntity> = new EventEmitter();

	public Workshop: AddressEntity;
	...
	private ParseAddress(components: google.maps.GeocoderAddressComponent[], lat: number, lng: number): void {
		...
		this.Workshop.number = streetNumber;
